...
public class Coding extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3668832070041996248L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Coding\",\"namespace\":\"com.flink.schema\",\"fields\":[{\"name\":\"code\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"display\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"system\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public Coding(java.lang.CharSequence code, java.lang.CharSequence display, java.lang.CharSequence system) {
    this.code = code;
   ...
   */
  public static com.flink.schema.Coding.Builder newBuilder() {
    return new com.flink.schema.Coding.Builder();
  }
   ...
   * @return A new Coding RecordBuilder
   */
  public static com.flink.schema.Coding.Builder newBuilder(com.flink.schema.Coding.Builder other) {
    if (other == null) {
      return new com.flink.schema.Coding.Builder();
    } else {
      return new com.flink.schema.Coding.Builder(other);
    }
  }
   ...
   * @return A new Coding RecordBuilder
   */
  public static com.flink.schema.Coding.Builder newBuilder(com.flink.schema.Coding other) {
    if (other == null) {
      return new com.flink.schema.Coding.Builder();
    } else {
      return new com.flink.schema.Coding.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Coding>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.flink.schema.Coding.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.flink.schema.Coding other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.code)) {
        this.code = data().deepCopy(fields()[0].schema(), other.code);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flink.schema.Coding.Builder setCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flink.schema.Coding.Builder clearCode() {
      code = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flink.schema.Coding.Builder setDisplay(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flink.schema.Coding.Builder clearDisplay() {
      display = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flink.schema.Coding.Builder setSystem(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.flink.schema.Coding.Builder clearSystem() {
      system = null;
